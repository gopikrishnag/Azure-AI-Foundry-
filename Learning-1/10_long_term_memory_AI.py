...
Examples:
- "My name is Gopi" → {{"name": "Gopi"}}
- "I'm a IT consultant" → {{"profession": "IT consultant"}}
- "I love South Indian food and my favorite color is blue" → {{"favorite_food": "South Indian food", "favorite_color": "blue"}}
- "How are you?" → {{}}
